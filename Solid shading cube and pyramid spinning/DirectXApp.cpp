...
void DirectXApp::Update()
{
	...
	_pyramidWorldTransformation = Matrix::CreateRotationY(-_rotationAngle * XM_PI / 60.0f) * Matrix::CreateTranslation(Vector3(5.0f, 0.0f, 0.0f)) * Matrix::CreateRotationY(_rotationAngle * XM_PI / 180.0f);
